...
List.prototype = {
    ...
    */
    indexOf: function(data) {
        ...
        var node = this.start;
        var i = 0;
        //node.next is picking ahead
        // so we rather use to node!==null
        while(node!==null){
            if(node.data === data){
                return i;
            }
...
//Add Comment C
    ...
    */
    delete: function(data){
        ...
        var i;
        var indexOfData=this.indexOf(data)
        indexOfData.splice(i);
        LinkedList.print();
